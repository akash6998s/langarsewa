          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredMembers.map((member) => (
                <div key={member.id} className="group relative bg-white rounded-3xl p-3 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 animate-fadeIn">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-bold text-slate-800 mb-2">{member.name} {member.last_name}</h3>
                    ...
                    {/* Footer */}
                    <div className="pt-1 border-t border-slate-50 flex items-center justify-between text-slate-400">
